...
var pokemonNames = ["Bulbasaur", "Ivysaur", "Charmander", "Charizard", "Squirtle", "Wartortle", "Caterpie", "Metapod", "Butterfree", "Pidgeotto", "Pidgeot", "Raticate", "Fearow", "Arbok", "Pikachu", "Raichu", "Sandshrew", "Nidoran", "Clefairy", "Clefable", "Vulpix", "Ninetales", "Jigglypuff", "Gloom", "Vileplume", "Paras", "Venonat", "Diglett", "Psyduck", "Primeape", "Growlithe", "Arcanine", "Poliwag", "Abra", "Alakazam", "Bellsprout", "Tentacruel", "Geodude", "Ponyta", "Slowbro", "Magnemite", "Farfetchd", "Dodrio", "Seel", "Dewgong", "Muk", "Cloyster", "Gastly", "Haunter", "Gengar", "Onix", "Krabby", "Exeggcute", "Cubone", "Marowak", "Koffing", "Rhydhorn", "Kangaskhan", "Horsea", "Seaking", "MrMime", "Scyther", "Jynx", "Magmar", "Pinsir", "Magikarp", "Lapras", "Ditto", "Eevee", "Kabuto", "Kabutops", "Aerodactyl", "Snorlax", "Zapdos", "Moltres", "Dragonite", "Mewtwo"];
